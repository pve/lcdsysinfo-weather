...
url = "https://api.cloudmonitor.ca.com/1.6/rule_stats?nkey=" + nkey + "&tags=myproduction&start_date=2013-09-27&callback=json"
...
print "Watchmouse errors: " + totalerrors + " / " + totalchecks + bad
